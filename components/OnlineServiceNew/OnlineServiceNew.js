// components/OnlineServiceNew/OnlineServiceNew.js
var e=getApp();
var ws;
Page({
  ...
  onLoad: function (options) {    
    var that = this;
    e.getNewUserInfo(options.id,function(data){        
        data.Status=='OK'?that.setData({toUserInfo:data.Data}):'';
    });
  ...
  quicksend:function(a){
    var t=this;
    var msg= a.currentTarget.dataset.msg;
    t.setData({
      msginfo:msg
    })
    t.send();
  ...
  send: function () {
    ...
    var UserName =t.data.servername||("Applet_" +t.data.userinfo.realName||t.data.userinfo.UserId);
    wx.request({
      ...
      data: {
        ...
        IsClient:true,
        PushClientId:t.data.toUserInfo?t.data.toUserInfo.ClientId:''
      },
      success(res) {
        t.setData({
          msginfo: '',
  ...
  onlineserver: function () {    
    ...
    var appKey = t.data.AppPushAppKey;   
    var UserName =t.data.servername||("Applet_" +t.data.userinfo.realName||t.data.userinfo.UserId);
    var clientId=t.data.userinfo.UserId;

    var url = 'wss://im.zhuanyegou.com/api/WebSocketApi/GetWebSocketApi' + '?id='+id+'&clientId='+clientId+'&UserName='+UserName+'&appKey='+appKey;
